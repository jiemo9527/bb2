...
<body>
	<div class="top" id="wyqtb">
		...
		<div class="dao_hang" style="background-color: #6C89B2;">
			...
			<!--结束-->
						<div class="dao_list">
				<a href="/index.do">首页</a> <a href="/favoriteList.do">视频收藏</a>
...
window.onload=function(){
	...
	<div class="centers_m">
		...
		<div class="public_m1">
			...
			<form action="/ua_back.do" method="post">
			<div class="public_m4">
				<p>
				...
				<p>
					<em>用户真实名字：</em> <input type="text" name="userName" value="${userDetail.userName}"
						style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</p>

				<p>
					<em>手机号：</em> <input type="text" name="userPhone" value="${userDetail.userPhone}"
						style="height: 23px; border: 1px solid #eaeaea; width: 140px">
				</p>
				
				<p>
					<em>收货地址：</em> <input type="text" name="userAddress" value = "${userDetail.userAddress}"
