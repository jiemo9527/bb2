	...
	<div class="top" id="wyqtb">
		...
		<div class="dao_hang" style="background-color: #6C89B2;">
			...
			<div class="dao_list">
				...
				<a href="javascript:return false;">视频收藏</a>
...
<%-- 				<div class="centers_listm_one_in">
		...
		<div class="public_m1">
			...
			<form action="${pageContext.request.contextPath}/uph_back.do" method="post">
				<div class="public_m4">
					<p>
					...
					<p>
						<em>收到的验证码：</em> <input name="vcode" type="text"
							style="height: 23px; border: 1px solid #eaeaea; width: 140px">
					<div style="color: blue">验证码为：56143</div>
