...
<body>
	<div class="top" id="wyqtb">
		...
		<div class="dao_hang" style="background-color: #6C89B2;">
			...
			<!--结束-->
			<div class="dao_list">
				<a href="/index.do">首页</a> <a href="/favoriteList.do">
				视频收藏</a> <a href="/surrounding.do">周边</a>
...
<%-- 				<div class="centers_listm_one_in">
		...
		<div class="public_m1">
			...
			<!--提示信息-->
			<form action="/upp_back.do" method="post">
				<div class="tip_notem">
					<ul>
						<li>1.请牢记支付密码</li>
						<li>2.如果丢失密码，可以通过绑定的手机或邮箱找到</li>
						<span style="color: red">
							<li style="color: red">3.如未设置支付密码 默认支付密码为123456</li>
						</span>
					</ul>
				</div>
				<div class="public_m4">
