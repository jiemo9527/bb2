...
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/User_Data_Update/css/jiazaitoubu.css"
	type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/User_Data_Update/css/css.css"
	type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/User_Data_Update/css/center.css"
	type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/User_Data_Update/city/city.css"
	type="text/css" />
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/static/User_Data_Update/css/shangchuan.css"
	type="text/css" />

<script src="${pageContext.request.contextPath}/static/User_Data_Update/js/jquery.form.js"></script>
<script
	src="${pageContext.request.contextPath}/static/User_Data_Update/js/jquery-1.8.3.min.js"></script>
<script
	src="${pageContext.request.contextPath}/static/User_Data_Update/js/index2.js"></script>
<script
	src="${pageContext.request.contextPath}/static/User_Data_Update/js/index2.js"></script>
...
<body>
	<!-- 这里是上传头像界面 -->
	<div id="dialog" style="height: 350px">
		<p class="close">
			<a href="/userInformation.do" onclick="closeBg();">关闭</a>
		</p>
		<!-- <div>正在加载，请稍后....</div> -->
		<div >
			<form  id="form" action="${pageContext.request.contextPath}/u_pic.do" enctype="multipart/form-data" method="post">
				<img style="margin-left:97px" id="pic" src="${userDetail.picture}" width="200px" height="200px">
				<br>
				<br>  <input style="margin:12px 0 0 155px" type="file" name="pic1" onchange="submitImg()">
				<input type="hidden" id="hiddenpic" name="pic" value="${userDetail.picture}">
				<input style="font-size: 18px;margin:12px 0 0 160px;color: red"  type="submit" value="更新">
			</form>
		</div>
	...
	<div class="top" id="wyqtb">
		...
		<div class="dao_hang" style="background-color: #6C89B2;">
			...
			<div class="dao_list">
				...
				<a href="/favoriteList.do">视频收藏</a>
				<a href="/surrounding.do">周边</a>
	...
	<div class="centers_m">
		...
		<div class="centers_ml">
			...
			<div class="center_header">
				<a href="/userInformation.do"><img
					src="${pageContext.request.contextPath}${userDetail.picture}" /></a> <em>您好，<font>${userDetail.userName}</font></em>
				<!-- <a href="">上传头像</a></font>	 -->
                <font style="color: red; font-size: 10px;">(下方可修改资料~喵)</font>
			</div>
			...
			<div class="centers_listm">
				...
				<span class="gjszmdm"> <a href="javascript:showBg();"
					...
					<a href="/info.do" class="center_in_self"><font>信息资料</font></a>
					<a href="/bankCard.do" class="center_in_self"><font>银行卡管理</font></a>
					<a href="/userAddress.do" class="center_in_self"><font>收货地址管理</font></a>
				</span>
				<!--一条开始-->
				<div class="centers_listm_one_in">
					<img
		...
		<div class="centers_mr">
			<h1 class="welcom_tm">
				...
				欢迎您，超级会员 <font>${userDetail.userName}</font>
				！您上次登录时间为<custom id="loginTime" style="color: #944019">${userDetail.lastLoginTime}</custom>


				<div class="gezhong_szm_in" style="margin-top: -50px;margin-left: 40px">
						<a href="/exit.do">切换账号</a>
						<a href="/videoUpload.do">我要投稿</a>
						</div>
			</h1>
			<!--一条开始-->
			<div>您的账户当前余额为:${userDetail.userMoney}　元</div>
			<div class="public_m1">
				...
				<div class="gezhong_szm">
					...
					<div class="gezhong_szm_in">
						...
						<a href="/updatePayPassword.do">修改密码</a>
					</div>
				</div>
			</div>
		</div>
