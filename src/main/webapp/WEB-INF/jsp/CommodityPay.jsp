...
<div class="showall" align="center">
	                ...
	                <div class="showbot">
                    <div id="showbox">
                        <img src="${pageContext.request.contextPath}${commodity.commodityImg}" width="400" height="400" />
                        ...
                        <div class="tb-property">
                        	<div class="tr-nobdr">
                        		...
                        		<div class="txt">
                        			<span class="nowprice">￥<a href="">${commodity.commodityPrice}</a></span>
                        	...
                        	<div class="gcIpt">
                        		...
                        		<span class="Hgt">库存（${commodity.commodityAmount}）</span>
                        	</div>
                        	<div class="nobdr-btns">
                        		...
                        		<button class="addcart yh" id="car"><img src="<%=request.getContextPath()%>/static/grids/gridsPay/images/shop.png" width="25" height="25"/>加入购物车</button>
                        	</div>
                        	<div class="guarantee">
	...
	<script type="text/javascript">
		$("#lijigoumai").click(function(){
			...
			var Cnum=$("#text_box").val();
			if(user!="null"){
				var a="confirmOrder.do?commodityID=${commodity.commodityID}&number="+Cnum;
				location.href =  a;
			}else{
				alert("请登录之后购买！");
	...
	<script>
		$("#car").click(function() {
			var user = "<%=request.getSession().getAttribute("userName")%>";
			var Cname="${commodity.commodityName}";
			var Cprice="${commodity.commodityPrice}";
			var Cnum=$("#text_box").val();
			var total=Cprice*Cnum;
			var CId="${commodity.commodityID}";
			var CImg="${commodity.commodityImg}";
			if(user!="null"){
				location.href ="shoppingCar.do?user="+user+"&Cname="+Cname+"&total="+total+"&CId="+CId+"&CImg="+CImg;
			}else{
				alert("请登录之后添加商品到购物车！");
				location.href = "login.do";
			}
