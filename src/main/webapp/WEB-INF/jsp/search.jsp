        ...
        <div class="mainCont clearfix" id="dance" js-move="true">
            <div class="pic-list fl" js-tab="true">
                ...
                <ul class="pic-list__wrapper clearfix tab-cont__item tab-cont__cur">
                    <!-- 这里开始遍历 -->
                    <c:forEach items="${serachVideos}" var="serachVideos">
                        <li class="item">
                            <a href="video.do?url=${serachVideos.url}"
                               class="img-link"> <img
                                    src="${serachVideos.img}">
                                <span class="mask"></span>
                            </a>
                            <div class="img-info">
                                <a href="video.do?url=${serachVideos.url}">${serachVideos.title }</a>
                                <div class="btm">
                                    <div class="user">
                                        <i></i>admin
                                    </div>
