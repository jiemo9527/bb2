	...
	<div class="centers_m">
		...
		<div class="centers_ml">
			...
			<div class="centers_listm">
				...
				<span class="gjszmdm"> <a href="/userInformation.do" class="center_in_self"><font>信息资料</font></a>
					<a href="/bankCard.do" class="center_in_self"><font>银行卡管理</font></a> <a
...
<%-- 				<!--一条开始-->
		...
		<div class="public_m1">
			...
			<form action="${pageContext.request.contextPath}/up_back.do" method="post">
				<div class="public_m4">
					<p>
					...
					<p>
						<em>新的密码：</em> <input type="password" name="newPassWord"
							style="height: 23px; border: 1px solid #eaeaea; width: 140px">
					</p>
					<p>
						<em>确认密码：</em> <input type="password" name="newPassWord2"
							style="height: 23px; border: 1px solid #eaeaea; width: 140px">
					</p>
