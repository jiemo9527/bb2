    ...
    <div style="overflow:auto;height:100%; width:100%">
      <table width="100%" border="0" cellpadding="3" cellspacing="1" class="table1">
        ...
        <TR>
          ...
          <TD align="center">${users.userAddress}</TD>
          <TD align="center">${users.userState }</TD>
		  <TD width="160" align="center">
				<BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('通过审核？'))
						location.href='approvedUser.do?userName=${users.userName}';else return;">通过审核</BUTTON>

			<BUTTON style="height:21px; font-size:12px" onClick="javascript:if (confirm('通过审核？'))
					location.href='freezeUser.do?userName=${users.userName}';else return;">冻结账号</BUTTON></TD>
        </TR>
			</c:forEach>
      </table>
    </div>
